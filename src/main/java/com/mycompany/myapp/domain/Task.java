...
public class Task implements Serializable {
    ...
    public Task transactions(Set<Transaction> transactions) {
    ...
    public Task addTransaction(Transaction transaction) {
        ...
        transaction.setRelatedTransaction(this);
        return this;
    }
    ...
    public SubTask getIdParent() {
        return idParent;
    }

    public Task idParent(SubTask subTask) {
        this.idParent = subTask;
        return this;
    }

    public void setIdParent(SubTask subTask) {
        this.idParent = subTask;
    }
