...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.mycompany.myapp.domain.Task.class.getName() + ".transactions");
            createCache(cm, com.mycompany.myapp.domain.Task.class.getName() + ".jobs");
            createCache(cm, com.mycompany.myapp.domain.SubTask.class.getName());
            createCache(cm, com.mycompany.myapp.domain.SubTask.class.getName() + ".tasks");
